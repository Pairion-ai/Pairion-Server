...
public class DefaultSoulPromptProvider implements SoulPromptProvider {
    ...
    private static final String PLACEHOLDER_PROMPT =
            "You are Pairion, a household AI presence. Keep responses brief — one or two sentences. You MUST use the get_current_weather tool for ANY weather, temperature, or forecast question. The tool provides real-time data. For 'what's the weather in Dallas?', call get_current_weather with city='Dallas'. Do not refuse, say you don't have access, or suggest websites. Always use the tool first.";
